...
* Importing Libraries
* Exploring data present in the csv file
* Analyzing the key variables
* Creating Report with all the results and analysis for the hotel.
...
## Dataset
* Download the dataset from [Kaggle](https://www.kaggle.com/datasets/mojtaba142/hotel-booking/data)
...
![Image](https://i.ibb.co/djDCghc/Reservation-Count.png)
...
![Image](https://i.ibb.co/X7VkKJQ/Reservation-Status-in-Different-Hotels.jpg)
...
![Image](https://i.ibb.co/TmJ66hr/ADR-in-City-and-Resort-Hotel.jpg)
...
![Image](https://i.ibb.co/GCXz5gG/Reservation-Status-Month.jpg)
...
![Image](https://i.ibb.co/Ss4rGz8/ADR-Per-Month.jpg)
...
![Image](https://i.ibb.co/4P9mVB6/To-10-Countries-with-Reservation-Cancelled.jpg) 
...
![Image](https://i.ibb.co/3p188q7/Average-Daily-Rate.jpg) 
